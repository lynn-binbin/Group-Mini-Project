  ...
  "use strict";
	...
	$('div.prt_img_click').on('click' , function(){
		if(!$(this).hasClass('active')){
			$('div.prt_CCCCC_slider_imgs img').removeClass('active');
			var target = $('div.prt_CCCCC_slider_imgs .img_'+$(this).attr('id'));
			var targetImg = target[0].outerHTML;
			target.remove();
			$('div.prt_CCCCC_slider_imgs').prepend(targetImg);
			$('div.prt_CCCCC_slider_imgs img:first').addClass('active');
			$('div.prt_CCCCC_slider_box .prt_img_click').removeClass('active');
	...
	var tar;
	var timing = 500;
	$('div.fixed-nav-bar a').on('click' , function(e){
		e.preventDefault();
